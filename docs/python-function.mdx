...
The example below is very simple. A True or False indicator is shown based on Brazil's zip codes. The function returns True when the format is "XXXXX-XXX" and "XXXXXXXXX".
