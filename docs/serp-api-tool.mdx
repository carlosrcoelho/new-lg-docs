...
- [`SerpAPI`](https://python.langchain.com/en/latest/modules/agents/tools/examples/google_serper.html)
- [`ZeroShotPrompt`](https://python.langchain.com/en/latest/modules/prompts/chat_prompt_template.html)
...
- [`ZeroShotAgent`](https://python.langchain.com/en/latest/modules/agents/agents/custom_mrkl_agent.html)
:::